...
export function Research({ initialSubpath }: ResearchProps) {
  ...
  const navigateToTab = (tabId: string, subpath?: string) => {
    setActiveTab(tabId);
    const targetUrl = subpath ? `/research/secureedge/${subpath}` : `/research/secureedge`;
  ...
  return (
    <div className="min-h-screen bg-[#06070c] text-white pt-20 pb-28 relative selection:bg-[#00d4ff]/20 selection:text-[#00d4ff]">
      ...
      <div className="sticky top-16 z-40 bg-[#06070c]/90 backdrop-blur-xl border-b border-white/10 px-4 sm:px-6 lg:px-8 py-3">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 space-y-24">
        {/* ========================================================================= */}
        ...
        <section id="overview" className="relative pt-6">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            >
              <ShieldCheck size={14} />
              <span>ACADEMIC & ENGINEERING RESEARCH PROPOSAL</span>
            </motion.div>
          ...
          <div className="text-center max-w-3xl mx-auto mb-8">
            ...
            <div className="flex items-center justify-center gap-2 mt-6">
              <button
                onClick={() => {
                  setActiveTransferTab('transfer');
                  window.history.pushState({}, '', '/research/secureedge/transfer-learning');
                }}
              ...
              <button
                onClick={() => {
                  setActiveTransferTab('incremental');
                  window.history.pushState({}, '', '/research/secureedge/incremental-learning');
                }}
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
              ...
              <button
                onClick={() => {
                  setActiveTransferTab('tinyml');
                  window.history.pushState({}, '', '/research/secureedge/tinyml');
                }}
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
